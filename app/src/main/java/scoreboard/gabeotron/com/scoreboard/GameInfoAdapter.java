 ...
 */
public class GameInfoAdapter extends RecyclerView.Adapter<GameInfoAdapter.VersionViewHolder> {
    ...
    public GameInfoAdapter(List<String> versionModels) {
        isHomeList = false;
    ...
    public VersionViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.custom_game_info_item, viewGroup, false);
