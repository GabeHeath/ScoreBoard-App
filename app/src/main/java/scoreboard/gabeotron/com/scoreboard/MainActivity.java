...
public class MainActivity extends AppCompatActivity {
    ...
    private PlayTabsPagerAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new PlayTabsPagerAdapter(getSupportFragmentManager());
        ...
        mCollapsingToolbarLayout.setTitle(getResources().getString(R.string.title_activity_main));

        /**
         * Spinner Logic - Set listener
         */
        addListenerOnSpinnerItemSelection();
    }

    /**
     * When Spinner item selected run CustomSpinnerListener
     */
    private void addListenerOnSpinnerItemSelection() {
        mSpinner = (Spinner) findViewById(R.id.pages_spinner);
        mSpinner.setOnItemSelectedListener(new CustomSpinnerListener());
    }
...
class PlayTabsPagerAdapter extends FragmentStatePagerAdapter {

    public PlayTabsPagerAdapter(FragmentManager fm) {
        super(fm);
    }
